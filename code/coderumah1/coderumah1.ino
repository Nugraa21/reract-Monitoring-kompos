...
void loop() {
  ...
  // --- Format JSON ---
  // Buffer diperbesar untuk menampung data tambahan
  char jsonPayload[150]; 
  // Ditambahkan field "rumah" ke dalam format JSON
  snprintf(jsonPayload, sizeof(jsonPayload),
           "{\"suhu\":\"%s\",\"jarak1\":\"%s\",\"jarak2\":\"%s\",\"rumah\":\"%s\"}",
           suhuStr, jarak1Str, jarak2Str, RUMAH_ID);
